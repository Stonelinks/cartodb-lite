...
// helper to get pixel position from latlon
    ...
    var CartoDBNamedMap = function (opts) {
        ...
        if (this.options.cartodb_logo != false)
            cdb.geo.common.CartoDBLogo.addWadus({
                left: 74,
                bottom: 8
            }, 2000, this.options.map.getDiv());
...
// CartoDBLayerGroup type
    ...
    _.extend(CartoDBLayerGroup.prototype, LayerDefinition.prototype, CartoDBLayerGroupBase.prototype, cdb.geo.CartoDBLayerCommon.prototype);
    CartoDBLayerGroup.prototype.interactionClass = wax.g.interaction;


// CartoDBNamedMap
    CartoDBNamedMap.prototype = new wax.g.connector();
    _.extend(CartoDBNamedMap.prototype, NamedMap.prototype, CartoDBLayerGroupBase.prototype, cdb.geo.CartoDBLayerCommon.prototype);
