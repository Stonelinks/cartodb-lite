...
// layer factory
        ...
        var Vis = cdb.core.View.extend({
            ...
            initialize: function () {
                ...
                if (this.options && this.options.mapView) {
            ...
            checkModules: function (layers) {
                ...
                return _.every(_.map(mods, function (m) {
                    return cartodb[m] !== undefined;
                }));
            },
            ...
            load: function (data, options) {
                ...
                if (data.slides && data.slides.length > 0) {
                    layers = layers.concat(_.flatten(data.slides.map(function (s) {
                        return s.layers
                    })));
                }
            ...
            _createOverlays: function (overlays, vis_data, options) {
                ...
                if ((options["slides_controller"] || options["slides_controller"] === undefined) && !this.mobile_enabled && !_.find(overlays, function (o) {
                        return o.type === 'header' && o.options.display;
                    })) {
