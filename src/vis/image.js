...
module.exports = function (cdb) {
    (function () {
        ...
        StaticImage.prototype = _.extend({}, cdb.geo.MapBase.prototype, {
            ...
            _getTorqueLayerDefinition: function (layer_definition) {
                ...
                var layerDefinition = new cdb.geo.LayerDefinition(layer_definition, layer_definition.options);
            ...
            _getLayergroupLayerDefinition: function (layer) {
                ...
                var layerDefinition = new cdb.geo.LayerDefinition(options.layer_definition, options);
